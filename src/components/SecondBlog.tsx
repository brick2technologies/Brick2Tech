...
const SecondBlog: React.FC = () => {
  return (
    <div className="bg-gray-50 font-serif text-gray-800">
      ...
      {/* Hero Image */}
      <div
        className="w-full h-[90vh] bg-cover bg-center border-b-4 border-blue-500"
        style={{
          backgroundImage:
            "url(https://res.cloudinary.com/di1bfo7ma/image/upload/v1760509115/Why-Brands-need-right-Digital-Marketing-Ststegy_p1lrg0.jpg)",
        }}
        aria-label="Digital Marketing Strategy - Brick2Tech Hyderabad"
      ></div>
