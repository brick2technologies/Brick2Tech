        ...
        <div className="bg-white text-darkblue font-sans">
            ...
            <main>
                ...
                <motion.section
                    ...
                    className="relative flex flex-col lg:flex-row items-center justify-between min-h-[90vh] px-6 py-24 bg-white"
                    aria-label="Hero section"
                >
                    {/* Left: Content + Swinging Lightbulb */}
                    <div className="lg:w-1/2 text-center lg:text-left">
                        <motion.div
                            animate={{
                                rotate: [0, 5, -5, 5, 0], // swinging
                                y: [0, 10, -10, 10, 0],   // bounce
                            }}
                            transition={{
                                duration: 3,
                                repeat: Infinity,
                        ...
                        <h1 className="text-4xl sm:text-5xl font-extrabold mb-6 text-darkblue">
                        ...
                        <motion.a
                            ...
                            href="#services"
                            className="inline-flex items-center gap-3 bg-darkblue text-white px-8 py-4 rounded-full 
                 font-semibold shadow-lg hover:bg-skyblue hover:text-darkblue transition"
                        >
                            Discover Our Services <ArrowRight className="w-5 h-5" />
                        </motion.a>
                    </div>

                    {/* Right: Desktop PNG Image */}
                    {/* Right: Desktop PNG Image with Swinging Animation */}
<motion.div
  animate={{
    rotate: [0, 2, -2, 2, 0],     // gentle left-right swing
    y: [0, 4, -4, 4, 0],          // subtle up-down motion
  }}
  transition={{
    duration: 4,
    repeat: Infinity,
